...
module.exports = function (grunt) {
    ...
    var seleniumPath = path.resolve('selenium');
    // configurable paths
    var yeomanConfig = {
        app: 'app',
        dist: 'dist'
    ...
    grunt.initConfig({
        ...
        shell: {
            // shutting down selenium http://localhost:4444/selenium-server/driver/?cmd=shutDownSeleniumServer
            selenium: {
